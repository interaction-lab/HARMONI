...
class YoloServicePytree(py_trees.behaviour.Behaviour):
    def __init__(self, name):
        ...
        super(YoloServicePytree, self).__init__(name)
    ...
    def setup(self):
        ...
        """
        self.logger.debug("  %s [YoloServicePytree::setup()]" % self.name)
    ...
    def initialise(self):
        ...
        What to do here?
          ...
          to work.
        """
        self.logger.debug("  %s [YoloServicePytree::initialise()]" % self.name)
    ...
    def update(self):
        ...
        """
        self.logger.debug("  %s [YoloServicePytree::update()]" % self.name)
    ...
    def terminate(self, new_status):
        ...
        """
        self.logger.debug("  %s [YoloServicePytree::terminate().terminate()][%s->%s]" % (self.name, self.status, new_status))
