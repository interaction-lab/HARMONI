...
alias rlpcservices = "roslaunch harmoni_decision services.launch use_harmoni_services:=false"
alias rlharmoniservices="roslaunch harmoni_decision services.launch use_pc_services:=false"
